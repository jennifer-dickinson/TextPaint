...
//  TextPaint
//
//  draw.c is responsible for modifying the contents of a canvas, drawing a line and erasing columns and rows.
//
...
void eraseCell(canvas *, int, int);
/* Summary: Erases the cell of a canvas at a given position;
 * Parameters: canvas pointer, column position row position
 */
